...
class TestContractNegotiation2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContractNegotiation2:
        """Test ContractNegotiation2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractNegotiation2`
        """
        model = ContractNegotiation2()
        if include_optional:
            return ContractNegotiation2(
                id = '',
    ...
    def testContractNegotiation2(self):
        """Test ContractNegotiation2"""
