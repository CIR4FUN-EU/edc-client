...
class EndpointDataReferenceEntryV3(BaseModel):
    """
    EndpointDataReferenceEntryV3
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="@id")
    type: Optional[StrictStr] = Field(default=None, alias="@type", json_schema_extra={"examples": ["https://w3id.org/edc/v0.0.1/ns/EndpointDataReferenceEntry"]})
