...
class DataAddress(BaseModel):
    ...
    DataAddress
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="@type", json_schema_extra={"examples": ["https://w3id.org/edc/v0.0.1/ns/DataAddress"]})
    type: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["@type", "type"]
