...
class DataplaneMetadataSchema(BaseModel):
    """
    DataplaneMetadataSchema
    """ # noqa: E501
    type: StrictStr = Field(alias="@type")
    labels: Optional[List[StrictStr]] = None
    properties: Optional[Dict[str, Any]] = Field(default=None, json_schema_extra={"examples": [{"key": "value"}]})
    profiles: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["@type", "labels", "properties", "profiles"]
